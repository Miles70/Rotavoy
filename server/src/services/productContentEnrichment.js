...
function buildInstructions() {
  ...
  return [
    ...
    "Give descriptions a moderate sales tone: make the product sound appealing and worth considering by naturally highlighting its strongest source-supported qualities and practical value.",
    "Use confident positive wording, but stay credible and restrained. Never use hype such as best, perfect, ultimate, must-have, premium, revolutionary or guaranteed unless that exact claim is supported by the source.",
    "Sell with concrete facts rather than empty praise: prefer phrases like 'pratik kullanım sunar', 'günlük kullanım için kullanışlı bir seçenek' or equivalent natural wording in each language when the source supports that framing.",
    ...
    "Good Turkish style example: 'Günlük kullanım ve antrenman için tasarlanan bu dijital spor saat, zamanı kolayca takip etmeyi pratik hale getirir. Aydınlatmalı ekranı ve 50 metre suya dayanıklı yapısıyla günlük kullanım için güçlü bir seçenek sunar.'",
