...
const defaults = {
  ...
  description: "Discover popular products picked for this week's Rotavoy campaign.",
...
async function getCategorySlides(excludedProductKeys = []) {
  ...
  for (const category of categoryGroups) {
    ...
    slides.push({
      ...
      title: categoryLabel,
      description: `Fresh ${categoryLabel.toLowerCase()} picks selected from the Rotavoy catalog.`,
